...
func New() oauthint.Registration {
	return oauthint.Register(
		"wechat",
		integration.Presentation{Name: "微信开放平台", Description: "使用网站应用扫码登录", Color: "#07c160", IconRef: "antd:WechatOutlined"},
		config.MustContract[providerConfig](config.Policy{Secrets: []string{"/appSecret"}, CreateOnly: []string{"/key"}}),
		oauthint.Operations[providerConfig]{AuthorizeURL: wechatAuthorizeURL, Exchange: wechatExchange},
	)
}
