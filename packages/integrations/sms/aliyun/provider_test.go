...
func TestRequestValuesPreserveAliyunProtocolShape(t *testing.T) {
	target, template, params, err := requestValues(providerConfig{TemplateCode: "SMS_DEFAULT"}, smsint.Message{E164: "+8613800138000", Content: "123456"})
	if err != nil {
		t.Fatal(err)
	}
	...
	target, template, _, err = requestValues(providerConfig{TemplateCode: "SMS_DEFAULT"}, smsint.Message{TemplateCode: "SMS_CUSTOM", E164: "+14155552671", Content: "hello"})
	if err != nil {
		t.Fatal(err)
	}
