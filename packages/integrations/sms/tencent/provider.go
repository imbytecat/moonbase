...
func New() smsint.Registration {
	return smsint.Register("tencent", integration.Presentation{
		Name: "腾讯云短信", Description: "通过云短信服务发送验证码与通知", Color: "#0052d9", IconRef: "antd:MessageOutlined",
...
func newRequest(ctx context.Context, cfg providerConfig, message smsint.Message) *tcsms.SendSmsRequest {
