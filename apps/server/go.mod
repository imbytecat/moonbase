module github.com/imbytecat/moonbase/server
...
require (
	...
	github.com/imbytecat/moonbase/integrations v0.0.0
...
replace github.com/imbytecat/moonbase/integrations => ../../packages/integrations
