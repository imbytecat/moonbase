...
var (
	alipaySchema = schema.Schema{Fields: []schema.Field{
		...
		{Key: "authMethod", Label: "Auth method", Type: schema.Enum, Options: []string{"", "public_key", "cert"}},
		...
		{Key: "methods", Label: "Signed products", Type: schema.Enum, Options: providerMethods("alipay")},
	}}
	...
	wechatSchema = schema.Schema{Fields: []schema.Field{
		...
		{Key: "authMethod", Label: "Auth method", Type: schema.Enum, Options: []string{"", "public_key", "platform_cert"}},
		...
		{Key: "methods", Label: "Signed products", Type: schema.Enum, Options: providerMethods("wechat")},
	}}
)
