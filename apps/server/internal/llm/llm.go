...
var Purposes = integration.Catalog{{Key: PurposeChat, Name: "通用对话", Description: "供业务功能调用通用对话模型", Cardinality: integration.Single}}
...
func (c *Client) CompleteWith(ctx context.Context, p kitsettings.GenericProfile, system, user string) (string, error) {
